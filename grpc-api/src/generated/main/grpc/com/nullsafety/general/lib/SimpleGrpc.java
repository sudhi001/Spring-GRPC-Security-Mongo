package com.nullsafety.general.lib;
...
public final class SimpleGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.nullsafety.general.lib.HelloRequest,
      com.nullsafety.general.lib.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.nullsafety.general.lib.HelloRequest.class,
      responseType = com.nullsafety.general.lib.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.nullsafety.general.lib.HelloRequest,
      com.nullsafety.general.lib.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.nullsafety.general.lib.HelloRequest, com.nullsafety.general.lib.HelloReply> getSayHelloMethod;
      ...
      synchronized (SimpleGrpc.class) {
        if ((getSayHelloMethod = SimpleGrpc.getSayHelloMethod) == null) {
          SimpleGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.nullsafety.general.lib.HelloRequest, com.nullsafety.general.lib.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.nullsafety.general.lib.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.nullsafety.general.lib.HelloReply.getDefaultInstance()))
  ...
  public static abstract class SimpleImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(com.nullsafety.general.lib.HelloRequest request,
        io.grpc.stub.StreamObserver<com.nullsafety.general.lib.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.nullsafety.general.lib.HelloRequest,
                com.nullsafety.general.lib.HelloReply>(
  ...
  public static final class SimpleBlockingStub extends io.grpc.stub.AbstractBlockingStub<SimpleBlockingStub> {
     ...
     * </pre>
     */
    public com.nullsafety.general.lib.HelloReply sayHello(com.nullsafety.general.lib.HelloRequest request) {
  ...
  public static final class SimpleFutureStub extends io.grpc.stub.AbstractFutureStub<SimpleFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.nullsafety.general.lib.HelloReply> sayHello(
        com.nullsafety.general.lib.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.nullsafety.general.lib.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.nullsafety.general.lib.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class SimpleBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.nullsafety.general.lib.HelloWorldProto.getDescriptor();
    }
